{{-- ============================================================ --}}
{{-- 2. kategori-klinis/trash.blade.php --}}
{{-- ============================================================ --}}

@extends('layouts.lte.app')

@section('title', 'Trash - Kategori Klinis')
@section('page', 'Trash Kategori Klinis')
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-xl font-semibold text-white flex items-center">
                        ...
                        Trash - Kategori Klinis
                    </h2>
                    <p class="text-red-100 text-sm mt-1">Data kategori klinis yang telah dihapus sementara</p>
                </div>
                <div class="flex items-center space-x-4">
                    <span class="text-red-100">Total: {{ $kategoriKlinis->count() }} data</span>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-red-50 transition duration-150">
                        ...
                        <td class="p-4">
                            <div class="flex gap-2">
                                <form action="{{ route('admin.kategori-klinis.restore', $item->idkategori_klinis) }}"
                                      method="POST"
                                      onsubmit="return confirm('Apakah Anda yakin ingin mengembalikan kategori klinis ini?')">
                                    @csrf
                                    <button type="submit"
                                ...
                                <form action="{{ route('admin.kategori-klinis.force-delete', $item->idkategori_klinis) }}"
                                      method="POST"
                    ...
                    <tr>
                        <td colspan="6" class="p-8 text-center text-gray-500">
                            ...
                            <p class="text-sm text-gray-400 mt-2">Tidak ada data kategori klinis yang dihapus</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
        ...
        <div class="p-4 bg-gray-50 border-t border-gray-200 text-sm text-gray-700">
            Menampilkan <span class="font-medium">{{ $kategoriKlinis->count() }}</span> data di trash
        </div>
        @endif
    </div>
</div>
