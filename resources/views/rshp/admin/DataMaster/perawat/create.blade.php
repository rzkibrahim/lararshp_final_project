...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-green-700 to-green-600 px-6 py-4">
            <h2 class="text-xl font-semibold text-white">Tambah Data Perawat</h2>
            <p class="text-green-100 text-sm mt-1">Isi form berikut untuk menambahkan perawat baru</p>
        </div>
        ...
        <form action="{{ route('admin.perawat.store') }}" method="POST" class="p-6">
            ...
            <div class="mb-6">
                ...
                <select name="iduser" id="iduser"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition duration-200 @error('iduser') border-red-500 @enderror"
                        required>
                ...
                @enderror
                <p class="text-gray-500 text-xs mt-1">Pilih user yang akan dijadikan perawat</p>
            </div>
    ...
    <div class="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
        <div class="flex items-start space-x-3">
            ...
            <div>
                <h4 class="font-semibold text-green-900 mb-1">Informasi</h4>
                <ul class="text-green-800 text-sm space-y-1">
                    <li>• Pilih user yang akan diberi role perawat</li>
                    <li>• User yang sudah menjadi perawat tidak akan muncul di daftar</li>
                    <li>• Status aktif berarti perawat dapat login dan mengakses sistem</li>
                </ul>
            </div>
        </div>
    </div>
