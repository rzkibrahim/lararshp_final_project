{{-- ============================================================ --}}
{{-- 1. kategori/trash.blade.php --}}
{{-- ============================================================ --}}

@extends('layouts.lte.app')

@section('title', 'Trash - Kategori')
@section('page', 'Trash Kategori')
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-red-700 to-red-600 px-6 py-4">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-red-100 text-sm mt-1">Data kategori yang telah dihapus sementara</p>
                </div>
                <div class="flex items-center space-x-4">
                    <span class="text-red-100">Total: {{ $kategori->count() }} data</span>
                ...
                <tbody>
                        ...
                        <td class="p-4">
                            <div class="flex gap-2">
                                ...
                                <form action="{{ route('admin.kategori.restore', $item->idkategori) }}"
                                      method="POST"
                                      onsubmit="return confirm('Apakah Anda yakin ingin mengembalikan kategori ini?')">
                                    @csrf
                                    <button type="submit"
                                ...
                                {{-- Hard Delete Button --}}
                                <form action="{{ route('admin.kategori.force-delete', $item->idkategori) }}"
                                      method="POST"
                    ...
                    <tr>
                        <td colspan="6" class="p-8 text-center text-gray-500">
                            ...
                            <p class="text-sm text-gray-400 mt-2">Tidak ada data kategori yang dihapus</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
        ...
        <div class="p-4 bg-gray-50 border-t border-gray-200 text-sm text-gray-700">
            Menampilkan <span class="font-medium">{{ $kategori->count() }}</span> data di trash
        </div>
        @endif
    </div>
</div>
