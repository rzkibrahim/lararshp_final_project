...
{{-- VERSI DENGAN SOFT DELETE & TRASH --}}
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-700 to-blue-600 px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    {{-- ✅ TOMBOL TRASH --}}
                    <a href="{{ route('admin.jenis-hewan.trash') }}"
                       class="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition duration-200">
                        <i class="fas fa-trash mr-2"></i>Trash
                        @php
                            $trashCount = DB::table('jenis_hewan')->whereNotNull('deleted_at')->count();
                        @endphp
                        @if($trashCount > 0)
                            ...
                            <div class="flex gap-2">
                                ...
                                @else
                                    <button disabled
                                            ...
                                            title="Tidak dapat dihapus karena memiliki {{ $item->jumlah_ras }} ras">
        ...
        <div class="p-4 bg-gray-50 border-t border-gray-200 text-sm text-gray-700 flex justify-between items-center">
            <span>Menampilkan <span class="font-medium">{{ $jenisHewan->count() }}</span> data aktif</span>
            <a href="{{ route('admin.jenis-hewan.trash') }}" class="text-red-600 hover:text-red-800">
