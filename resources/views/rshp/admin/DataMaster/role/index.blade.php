...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('admin.role.trash') }}"
                        ...
                        @php
                        $trashCount = DB::table('role')->whereNotNull('deleted_at')->count();
                        @endphp
                        @if($trashCount > 0)
        ...
        <div class="p-4 bg-gray-50 border-t border-gray-200 text-sm text-gray-700 flex justify-between items-center">
            <span>Menampilkan <span class="font-medium">{{ $roles->count() }}</span> data aktif</span>
            <a href="{{ route('admin.role.trash') }}" class="text-red-600 hover:text-red-800">
