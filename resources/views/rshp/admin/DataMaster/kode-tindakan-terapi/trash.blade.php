{{-- ============================================================ --}}
{{-- 3. kode-tindakan-terapi/trash.blade.php --}}
{{-- ============================================================ --}}

@extends('layouts.lte.app')

@section('title', 'Trash - Kode Tindakan & Terapi')
@section('page', 'Trash Kode Tindakan & Terapi')
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-xl font-semibold text-white flex items-center">
                        ...
                        Trash - Kode Tindakan & Terapi
                    </h2>
                    <p class="text-red-100 text-sm mt-1">Data kode tindakan & terapi yang telah dihapus sementara</p>
                </div>
                <div class="flex items-center space-x-4">
                    <span class="text-red-100">Total: {{ $tindakanTerapi->count() }} data</span>
            ...
            <table class="min-w-full border-collapse">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-red-50 transition duration-150">
                        ...
                        <td class="p-4 text-gray-800">{{ Str::limit($item->deskripsi_tindakan_terapi, 50) }}</td>
                        ...
                        <td class="p-4">
                            <div class="flex gap-2">
                                <form action="{{ route('admin.kode-tindakan-terapi.restore', $item->idkode_tindakan_terapi) }}"
                                      method="POST"
                                      onsubmit="return confirm('Apakah Anda yakin ingin mengembalikan kode tindakan ini?')">
                                    @csrf
                                    <button type="submit"
                                ...
                                <form action="{{ route('admin.kode-tindakan-terapi.force-delete', $item->idkode_tindakan_terapi) }}"
                                      method="POST"
                    ...
                    <tr>
                        <td colspan="7" class="p-8 text-center text-gray-500">
                            ...
                            <p class="text-sm text-gray-400 mt-2">Tidak ada data kode tindakan yang dihapus</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
        ...
        <div class="p-4 bg-gray-50 border-t border-gray-200 text-sm text-gray-700">
            Menampilkan <span class="font-medium">{{ $tindakanTerapi->count() }}</span> data di trash
        </div>
        @endif
    </div>
</div>
